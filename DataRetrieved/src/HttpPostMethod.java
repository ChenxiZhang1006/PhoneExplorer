	...
	*/
	...
	public void executePostMethod(int opt){
		...
		if(opt == 1){
			...
			//method.setRequestHeader("Content-Length", "2363");
			
			method.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
			method.setRequestHeader("Host", "www.ncbi.nlm.nih.gov");
			method.setRequestHeader("Origin", "http://www.ncbi.nlm.nih.gov");
			
			method.setRequestHeader("Referer", "http://www.ncbi.nlm.nih.gov/gap/?term=2[s_discriminator]%20AND%201[Is%20Top-Level%20Study]&report=SVariables");
